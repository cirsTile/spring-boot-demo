...
import com.example.springbootjacksonvalidate.common.exception.BaseException;
import lombok.Data;
...
public class ApiResponse {
    ...
    public static <T extends Exception> ApiResponse ofAnother(T t) {
        return of(Status.UNKNOWN_ERROR.getCode(), Status.UNKNOWN_ERROR.getMessage(), t.getMessage());
    }
}
